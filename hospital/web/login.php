...
<body class="hold-transition skin-blue sidebar-mini" style="background-color:rgb(140,200,234)">
    ...
    <div style="text-align:center">
        <div style="text-align:center;background-color:rgb(140,200,234)">
            <div class="wrapper" style="width:1200px;margin-left:auto;margin-right:auto;margin-top:40px;">
                    ...
                    <div class="login-wrapper">
                        <div class="login-wrapper2">
                            <div class="login-wrapper3">
                                ...
                                <div class="form-group"><input class="form-control" type="text" name="login_name" value="" placeholder="请输入用户名" tooltip_msg="用户名不能为空"  autocomplete="off"></div>
                                <div class="form-group" style="margin-bottom:50px;"><input class="form-control" type="password" value="" name="login_password" placeholder="请输入密码" tooltip_msg="密码不能为空"  autocomplete="off"/></div>
