...
(function(window){
		...
		if (window.clipboardData) {
			...
			Clipboard = function(elem) {
				...
				if (! inited) {
					if (! required) {
						required = true;
						utils.require("/assets/js/ZeroClipboard.js", function(){
							inited = true;
							_.each(list, init);
						});
					}
		...
		if (window.clipboardData) {
			...
			Clipboard = function(elem) {
				...
				if (! inited) {
					if (! required) {
						required = true;
						utils.require("/assets/js/ZeroClipboard-2.x/ZeroClipboard.min.js", function(){
							inited = true;
							ZeroClipboard.config({swfPath: "/assets/js/ZeroClipboard-2.x/ZeroClipboard.swf"});
							_.each(list, init);
						});
					}
				} else {
	...
	utils.loader = (function(){
		...
		function Loader(target) {
			var elem = $('<div class="utils-loader"><div class="utils-loader-mask"></div><div class="utils-loader-body"><img src="/assets/images/ajax-loader.gif" width="32" height="32"></div></div>');
